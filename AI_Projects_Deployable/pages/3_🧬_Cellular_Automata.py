...
@st.cache_resource
def load_model():
    model_path = os.path.join("assets", "cellular_automata_models", "kmeans_model.joblib")
    scaler_path = os.path.join("assets", "cellular_automata_models", "scaler.joblib")
    labels_path = os.path.join("assets", "cellular_automata_models", "cluster_labels.joblib")
